                ...
                <div class="container-fluid">
                    <div class="table-container">
                        ...
                        <div class="form-container">
                            <form action="update_pendaftaran" method="post">
                                <div class="form-group">
                                    <label for="nama">Nama Calon Peserta Didik: (sesuaikan akta lahir)</label>
                                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Calon Peserta Dididik" required>
                                </div>
                                <div class="form-group">
